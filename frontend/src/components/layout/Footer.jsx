    ...
    <footer className="border-t border-border/60 bg-zinc-50 dark:bg-zinc-900/50" data-testid="footer">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          <div className="col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display font-bold text-xl">PrintForge</span>
            </div>
            ...
            <div className="mt-6 flex items-center gap-2 text-muted-foreground">
              ...
              <a href="mailto:hello@printforge.com" aria-label="Email" className="p-2 rounded-md hover:bg-accent hover:text-accent-foreground"><Mail className="h-4 w-4" /></a>
            </div>
          </div>
        ...
        <div className="mt-14 pt-6 border-t border-border/60 flex flex-col sm:flex-row items-center justify-between text-xs text-muted-foreground gap-2">
          <div>© {new Date().getFullYear()} PrintForge Studio. Printed with care.</div>
