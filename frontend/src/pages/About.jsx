    ...
    <div>
      <section className="relative overflow-hidden border-b border-border">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-xs uppercase tracking-[0.3em] text-orange-600 font-semibold">About PrintForge</div>
          ...
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-2xl">
            PrintForge started in a garage in 2022 with one Prusa MK3 and a stubborn belief that useful objects shouldn't have to travel across oceans to reach you. Four years and eight printers later, we still believe that.
          </p>
        </div>
      </section>
