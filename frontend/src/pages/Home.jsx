        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-28 sm:py-36 lg:py-44">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <p className="mt-6 max-w-xl text-lg text-muted-foreground leading-relaxed">
              PrintForge is a small studio printing thoughtful, useful things — one layer at a time. Order in seconds, on your desk in days.
            </p>
      ...
      <section className="bg-zinc-50 dark:bg-zinc-900/40 border-y border-border/60">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-2xl">
            <div className="text-xs uppercase tracking-[0.25em] text-orange-600 font-semibold">Why PrintForge</div>
